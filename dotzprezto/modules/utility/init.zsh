...
if is-callable 'dircolors'; then
  ...
  if zstyle -t ':prezto:module:utility:ls' color; then
    ...
    if [[ -z "$LSCOLORS" ]]; then
      export LSCOLORS='gxfxcxdxbxGxDxabaeacad'
    fi

    # Define colors for the completion system if they're not already defined
    if [[ -z "$LS_COLORS" ]]; then
      export LS_COLORS='di=36:ln=35:so=32:pi=33:ex=31:bd=34;01:cd=33;01:su=31;40;07:sg=33;40;07:tw=32;40;07:ow=33;40;07:'
    fi
